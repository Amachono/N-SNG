...
local Window = OrionLib:MakeWindow({Name = "Nico's Nextbots GUI", HidePremium = false, SaveConfig = true, ConfigFolder = "NextCFG"})
local Esp = false
local Names = false
...
Tab4:AddLabel("By: Kramos")
Tab4:AddLabel("Last update: 08/07/2022")
